import os
os.chdir("/Users/mahaoxi/Desktop/Machine Learning/ML in Python and R/Classification/Decision Tree")
...
classifier = DecisionTreeClassifier(criterion="entropy",random_state=0)#entropy代表不规律性
